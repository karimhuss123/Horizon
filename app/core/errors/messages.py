class ErrorMessages:
    def __init__(self):
        ...
        self.jobs_basket_regeneration_unexpected_error = "An unexpected error occurred while regenerating your basket. Please try again."
        self.jobs_basket_suggestions_unexpected_error = "An unexpected error occurred while getting your suggestions. Please try again."
